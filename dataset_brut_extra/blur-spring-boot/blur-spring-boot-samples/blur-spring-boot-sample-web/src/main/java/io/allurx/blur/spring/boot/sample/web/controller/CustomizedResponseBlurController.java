...
import static io.allurx.blur.spring.boot.sample.web.model.CustomizedResponse.ok;

/**
 * Controller for handling data blurring of {@link CustomizedResponse} types.
...
public class CustomizedResponseBlurController {
     ...
     * Default constructor
     */
    public CustomizedResponseBlurController() {
    }
     ...
     * @return a {@link CustomizedResponse} containing the blurred email
     */
    @GetMapping("/stringParameter")
    public CustomizedResponse<String> blurStringParameter(@RequestParam @Email String email) {
        return ok(email);
    }
    ...
    public CustomizedResponse<@Email String> blurStringReturnValue(@RequestParam String email) {
        return ok(email);
    }
     ...
     * @return a {@link CustomizedResponse} containing the blurred emails
     */
    @PostMapping("/collectionParameter")
    public CustomizedResponse<List<String>> blurCollectionParameter(@RequestBody List<@Email String> emails) {
        return ok(emails);
    }
    ...
    public CustomizedResponse<List<@Email String>> blurCollectionReturnValue(@RequestBody List<String> emails) {
        return ok(emails);
    }
     ...
     * @return a {@link CustomizedResponse} containing the blurred map
     */
    @PostMapping("/mapParameter")
    public CustomizedResponse<Map<String, Person>> blurMapParameter(@RequestBody Map<@Name String, @Cascade Person> map) {
        return ok(map);
    }
    ...
    public CustomizedResponse<Map<@Name String, @Cascade Person>> blurMapReturnValue(@RequestBody Map<String, Person> map) {
        return ok(map);
    }
    ...
    public CustomizedResponse<String[]> blurArrayParameter(@RequestBody @Email String[] array) {
        return ok(array);
    }
    ...
    public CustomizedResponse<@Email String[]> blurArrayReturnValue(@RequestBody String[] array) {
        return ok(array);
    }
     ...
     * @return a {@link CustomizedResponse} containing the blurred person
     */
    @PostMapping("/objectParameter")
    public CustomizedResponse<Person> blurObjectParameter(@RequestBody @Cascade Person person) {
        return ok(person);
    }
    ...
    public CustomizedResponse<@Cascade Person> blurObjectReturnValue(@RequestBody Person person) {
        return ok(person);
    }
}
