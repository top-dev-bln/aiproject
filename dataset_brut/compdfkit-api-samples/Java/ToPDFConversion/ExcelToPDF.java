package cn.kdan.javaDemo.ToPDFConversion;
...
public class ExcelToPDF {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/excel.xlsx";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/xlsx/pdf?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = ExcelToPDF.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "excel.xlsx", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
