...
public class WordToPDF {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/word.docx";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/docx/pdf?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = WordToPDF.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "word.docx", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
