...
public class PPTToPDF {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/ppt.pptx";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pptx/pdf?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PPTToPDF.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "ppt.pptx", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
