...
public class HTMLToPDF {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/html.html";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/html/pdf?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = HTMLToPDF.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "html.html", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
