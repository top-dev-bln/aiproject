...
public class CSVToPDF {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/csv.csv";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/csv/pdf?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = CSVToPDF.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "csv.csv", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
