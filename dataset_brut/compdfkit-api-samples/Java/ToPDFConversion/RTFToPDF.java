...
public class RTFToPDF {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/rtf.rtf";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/rtf/pdf?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = RTFToPDF.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "rtf.rtf", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
