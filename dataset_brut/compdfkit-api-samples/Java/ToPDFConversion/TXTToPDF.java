...
public class TXTToPDF {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/txt.txt";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/txt/pdf?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = TXTToPDF.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "txt.txt", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
