...
public class StampInspection {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/fapiao.png";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/documentAI/detectionStamp?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = StampInspection.class.getClassLoader().getResourceAsStream(pdfPath);
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "fapiao.png", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
