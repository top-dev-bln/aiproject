package cn.kdan.javaDemo.DocumentAI;
...
public class FormRecognizer {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/documentAI/tableRec?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = FormRecognizer.class.getClassLoader().getResourceAsStream(pdfPath);
