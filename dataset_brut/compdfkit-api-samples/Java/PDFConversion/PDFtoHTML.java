...
public class PDFtoHTML {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/html?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFtoHTML.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{  \"pageOptions\": 1 ,  \"isContainAnnot\": 1 ,  \"isContainImg\": 1,\"isAllowOcr\":0,\"isContainOcrBg\":1,\"isOnlyAiTable\":0}";
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "html.pdf", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
