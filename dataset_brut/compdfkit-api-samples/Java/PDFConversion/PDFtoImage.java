...
public class PDFtoImage {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/jpg?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFtoImage.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{  \"imgDpi\": \"300\",\"pages\":[1] }";
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "png.pdf", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
