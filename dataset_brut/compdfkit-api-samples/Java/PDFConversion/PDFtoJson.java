...
public class PDFtoJson {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/json?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFtoJson.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{  \"type\": 1, \"isAllowOcr\":0, \"isContainOcrBg\":0}";
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "json.pdf", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
