package cn.kdan.javaDemo.PDFConversion;
...
public class PDFtoExcel {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/xlsx?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFtoExcel.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{    \"contentOptions\": \"2\",    \"worksheetOptions\": \"1\", \"isContainAnnot\": 1, \"isContainImg\": 1,\"isAllowOcr\":0,\"isContainOcrBg\":0,\"isOnlyAiTable\":0}";
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "excel.pdf", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
