...
public class PDFtoWord {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/docx?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFtoWord.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{    \"isContainAnnot\": 1 ,  \"isContainImg\": 1,\"wordLayoutMode\":2,\"isAllowOcr\":0,\"isContainOcrBg\":0,\"isOnlyAiTable\":0,\"ocrLanguage\":0 }";
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "word.pdf", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
