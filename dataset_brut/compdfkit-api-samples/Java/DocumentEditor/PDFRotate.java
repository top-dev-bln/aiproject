...
public class PDFRotate {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/rotation?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFRotate.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{\"pageOptions\": \"['2']\",\"rotation\":\"90\" }";
