...
public class PDFSplit {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/split?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFSplit.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{\"pageOptions\":[\"1\",\"2-3\"]}";
