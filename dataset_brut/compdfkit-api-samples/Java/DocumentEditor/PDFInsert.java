...
public class PDFInsert {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/insert?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFInsert.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{\"targetPage\": \"2\",\"width\": \"500\",\"height\": \"800\", \"number\": \"2\"}";
