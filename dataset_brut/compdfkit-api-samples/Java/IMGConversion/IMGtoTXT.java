...
public class IMGtoTXT {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/img/txt?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = IMGtoTXT.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{    \"isAllowOcr\":1,\"isContainOcrBg\":0  }";
