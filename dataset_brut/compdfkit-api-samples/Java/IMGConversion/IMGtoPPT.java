...
public class IMGtoPPT {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/img/pptx?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = IMGtoPPT.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{    \"isAllowOcr\":1,\"isContainOcrBg\":0,\"isOnlyAiTable\":0 }";
