...
public class IMGtoCSV {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/img/csv?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = IMGtoCSV.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{  \"isCsvMerge\": 1 ,\"isAllowOcr\":1, \"isOnlyAiTable\":0 }";
