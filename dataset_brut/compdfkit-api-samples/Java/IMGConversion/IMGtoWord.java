...
public class IMGtoWord {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/img/docx?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = IMGtoWord.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{    \"wordLayoutMode\":2,\"isAllowOcr\":0,\"isContainOcrBg\":0,\"isOnlyAiTable\":0 }";
