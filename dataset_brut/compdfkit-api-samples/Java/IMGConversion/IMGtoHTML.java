...
public class IMGtoHTML {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/img/html?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = IMGtoHTML.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{  \"pageOptions\": 1 , \"isAllowOcr\":1,\"isContainOcrBg\":0,\"isOnlyAiTable\":0}";
