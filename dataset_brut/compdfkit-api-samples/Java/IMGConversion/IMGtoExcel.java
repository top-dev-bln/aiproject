package cn.kdan.javaDemo.IMGConversion;
...
public class IMGtoExcel {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/test.png";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/img/xlsx?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = IMGtoExcel.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{    \"contentOptions\": \"2\",  \"worksheetOptions\": \"1\", \"isAllowOcr\": 1,\"isContainOcrBg\":0,\"isOnlyAiTable\":0}";
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "test.png", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
