package cn.kdan.javaDemo.AdvancedFeatures;
...
public class AddWatermark {
    ...
    // PDF 文件路径
    private static final String pdfPath = "input_files/file.pdf";
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/addWatermark?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = AddWatermark.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{\"type\": \"text\",\"scale\":\"1\",\"opacity\":\"0.5\",\"rotation\":\"0.785\",\"targetPages\":\"1\",\"vertalign\":\"center\",\"horizalign\":\"left\",\"xoffset\":\"100\",\"yoffset\":\"100\",\"content\":\"test\",\"textColor\":\"#59c5bb\",\"front\":\"1\",\"fullScreen\":\"1\",\"horizontalSpace\":\"10\",\"verticalSpace\":\"10\",\"extension\":\"\"}";
        RequestBody uploadFileBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
                .addFormDataPart("file", "compare1.pdf", RequestBody.create(MediaType.parse("application/octet-stream"), readBytesFromInputStream(inputStream)))
