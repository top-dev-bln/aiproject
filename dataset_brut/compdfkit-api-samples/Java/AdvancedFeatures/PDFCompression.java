...
public class PDFCompression {
    ...
    public static void main(String[] args) {
        ...
        request = new Request.Builder()
                .url(CREATE_TASK_URL + "/pdf/compress?language=2")
                .method("GET", null)
        ...
        // 3.Upload File
        InputStream inputStream = PDFCompression.class.getClassLoader().getResourceAsStream(pdfPath);
        String parameter = "{\"quality\":\"50\"}";
