...
document.getElementById('uploadForm').addEventListener('submit', async function (event) {
  ...
  // 2.Create Task
  const createTaskResponse = await fetch('https://api-server.compdf.com/server/v1/task/pdf/insert?language=2', {
    method: 'GET',
    headers: {
  ...
  pdfData.append('parameter', '{ "targetPage": "2", "width": "500", "height": "800", "number": "2" }');
