...
document.getElementById('uploadForm').addEventListener('submit', async function (event) {
  ...
  // 2.Create Task
  const createTaskResponse = await fetch('https://api-server.compdf.com/server/v1/task/pdf/rotation?language=2', {
    method: 'GET',
    headers: {
  ...
  pdfData.append('parameter', '{ "pageOptions": "[\'2\']", "rotation":"90" }');
