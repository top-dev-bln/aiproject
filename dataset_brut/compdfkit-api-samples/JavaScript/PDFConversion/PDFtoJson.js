...
document.getElementById('uploadForm').addEventListener('submit', async function (event) {
  ...
  // 2.Create Task
  const createTaskResponse = await fetch('https://api-server.compdf.com/server/v1/task/pdf/json?language=2', {
    method: 'GET',
    headers: {
  ...
  pdfData.append('parameter', '{  "type": 1, "isAllowOcr":0, "isContainOcrBg":0}');
