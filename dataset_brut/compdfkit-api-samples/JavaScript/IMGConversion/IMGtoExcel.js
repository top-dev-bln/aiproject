...
document.getElementById('uploadForm').addEventListener('submit', async function (event) {
  ...
  // 2.Create Task
  const createTaskResponse = await fetch('https://api-server.compdf.com/server/v1/task/img/xlsx?language=2', {
    method: 'GET',
    headers: {
  ...
  pdfData.append('parameter', '{    "contentOptions": "2",  "worksheetOptions": "1", "isAllowOcr": 1,"isContainOcrBg":0,"isOnlyAiTable":0}');
