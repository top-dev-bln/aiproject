    ...
    class PDFtoRTF
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/rtf?language=2").Result;
                ...
                formData.Add(new StringContent("{  \"isContainAnnot\": 1 ,  \"isContainImg\": 1,\"isAllowOcr\":0,\"isContainOcrBg\":0}"), "parameter");
