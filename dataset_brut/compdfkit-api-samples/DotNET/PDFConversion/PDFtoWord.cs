    ...
    class PDFtoWord
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/docx?language=2").Result;
                ...
                formData.Add(new StringContent("{\"isContainAnnot\": 1,\"isContainImg\": 1,\"wordLayoutMode\": 2,\"isAllowOcr\": 0,\"isContainOcrBg\": 0,\"isOnlyAiTable\": 0,\"ocrLanguage\": 0}"), "parameter");
