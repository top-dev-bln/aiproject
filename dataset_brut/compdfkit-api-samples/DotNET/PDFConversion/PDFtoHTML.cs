    ...
    class PDFtoHTML
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/html?language=2").Result;
                ...
                formData.Add(new StringContent("{  \"pageOptions\": 1 ,  \"isContainAnnot\": 1 ,  \"isContainImg\": 1,\"isAllowOcr\":0,\"isContainOcrBg\":1,\"isOnlyAiTable\":0}"), "parameter");
