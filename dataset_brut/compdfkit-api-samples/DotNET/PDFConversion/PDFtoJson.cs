    ...
    class PDFtoJson
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/json?language=2").Result;
                ...
                formData.Add(new StringContent("{  \"type\": 1, \"isAllowOcr\":0, \"isContainOcrBg\":0}"), "parameter");
