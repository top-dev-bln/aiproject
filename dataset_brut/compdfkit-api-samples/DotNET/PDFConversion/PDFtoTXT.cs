    ...
    class PDFtoTXT
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/txt?language=2").Result;
                ...
                formData.Add(new StringContent("{  \"isAllowOcr\":0,\"isContainOcrBg\":0}"), "parameter");
