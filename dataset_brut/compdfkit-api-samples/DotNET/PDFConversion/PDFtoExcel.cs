    ...
    class PDFtoExcel
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/xlsx?language=2").Result;
                ...
                formData.Add(new StringContent("{    \"contentOptions\": \"2\",    \"worksheetOptions\": \"1\", \"isContainAnnot\": 1 , \"isContainImg\": 1,\"isAllowOcr\":0,\"isContainOcrBg\":0,\"isOnlyAiTable\":0}"), "parameter");
