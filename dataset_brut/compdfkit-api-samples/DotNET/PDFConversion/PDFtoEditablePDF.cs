    ...
    class PDFtoEditablePDF
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/editable?language=2").Result;
                ...
                formData.Add(new StringContent("{  \"lang\": \"1\"}"), "parameter");
