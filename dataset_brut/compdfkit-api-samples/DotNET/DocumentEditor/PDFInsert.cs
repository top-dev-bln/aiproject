    ...
    class PDFInsert
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/insert?language=2").Result;
                ...
                formData.Add(new StringContent("{\"targetPage\": \"2\",\"width\": \"500\",\"height\": \"800\", \"number\": \"2\"}"), "parameter");
