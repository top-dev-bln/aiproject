...
namespace PDFConversion
{
    ...
    {
        // PDF 文件路径
        private static readonly string pdfPath1 = "input_files/test.pdf";
        private static readonly string pdfPath2 = "input_files/word.pdf";
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/merge?language=2").Result;
                ...
                formData1.Add(new StringContent("{    \"pageOptions\": ['1,2']}"), "parameter");
