    ...
    class PDFRotate
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/rotation?language=2").Result;
                ...
                formData.Add(new StringContent("{\"pageOptions\": \"['2']\",\"rotation\":\"90\" }"), "parameter");
