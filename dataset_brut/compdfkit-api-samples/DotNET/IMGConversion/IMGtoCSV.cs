    ...
    class IMGtoCSV
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/img/csv?language=2").Result;
                ...
                formData.Add(new StringContent("{  \"isCsvMerge\": 1 ,\"isAllowOcr\":1, \"isOnlyAiTable\":0 }"), "parameter");
