    ...
    class IMGtoWord
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/img/docx?language=2").Result;
                ...
                formData.Add(new StringContent("{    \"wordLayoutMode\":2,\"isAllowOcr\":0,\"isContainOcrBg\":0,\"isOnlyAiTable\":0 }"), "parameter");
