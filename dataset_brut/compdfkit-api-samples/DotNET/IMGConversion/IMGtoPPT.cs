    ...
    class IMGtoPPT
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/img/pptx?language=2").Result;
                ...
                formData.Add(new StringContent("{    \"isAllowOcr\":1,\"isContainOcrBg\":0,\"isOnlyAiTable\":0 }"), "parameter");
