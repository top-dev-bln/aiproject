    ...
    class IMGtoHTML
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/img/html?language=2").Result;
                ...
                formData.Add(new StringContent("{  \"pageOptions\": 1 , \"isAllowOcr\":1,\"isContainOcrBg\":0,\"isOnlyAiTable\":0}"), "parameter");
