...
namespace PDFConversion
{
    ...
    {
        // PDF 文件路径
        private static readonly string pdfPath = "input_files/file.pdf";
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var createTaskResponse = client.GetAsync($"{CREATE_TASK_URL}/pdf/addWatermark?language=2").Result;
                ...
                formData.Add(new StringContent("{\"type\": \"text\",\"scale\":\"1\",\"opacity\":\"0.5\",\"rotation\":\"0.785\",\"targetPages\":\"1\",\"vertalign\":\"center\",\"horizalign\":\"left\",\"xoffset\":\"100\",\"yoffset\":\"100\",\"content\":\"test\",\"textColor\":\"#59c5bb\",\"front\":\"1\",\"fullScreen\":\"1\",\"horizontalSpace\":\"10\",\"verticalSpace\":\"10\",\"extension\":\"\"}"), "parameter");
