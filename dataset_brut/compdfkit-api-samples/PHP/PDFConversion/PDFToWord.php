...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => CREATE_TASK_URL . '/pdf/docx?language=2',
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => '',
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 0,
...
$params = [
    ...
    'parameter' => json_encode(['isContainAnnot' => 1, 'isContainImg' => 1, 'wordLayoutMode' => 2, 'isAllowOcr'=>0, 'isContainOcrBg'=>0, 'isOnlyAiTable'=> 0, 'ocrLanguage'=>0]),
    'language' => 2,
];
$headers = [
    'Authorization: ' . $bearerToken
