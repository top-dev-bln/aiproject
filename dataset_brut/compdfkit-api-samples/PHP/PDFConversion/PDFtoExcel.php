...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => CREATE_TASK_URL . '/pdf/xlsx?language=2',
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => '',
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 0,
...
$params = [
    ...
    'parameter' => json_encode(['contentOptions' => '2', 'worksheetOptions' => '1', 'isContainAnnot' => 1, 'isContainImg' => 1, 'isAllowOcr' => 0, 'isContainOcrBg' => 0, 'isOnlyAiTable' => 0]),
    'language' => 2,
];
$headers = [
    'Authorization: ' . $bearerToken
