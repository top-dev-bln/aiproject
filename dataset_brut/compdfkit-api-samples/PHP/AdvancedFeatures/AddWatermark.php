...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => CREATE_TASK_URL . '/pdf/addWatermark?language=2',
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => '',
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 0,
...
$params = [
    ...
    'parameter' => json_encode([ 'type' => 'text', 'scale' => '1', 'opacity' => '0.5', 'rotation' => '0.785', 'targetPages' => '1', 'vertalign' => 'center', 'horizalign' => 'left', 'xoffset' => '100', 'yoffset' => '100', 'content' => 'test', 'textColor' => '#59c5bb', 'front' => '1', 'fullScreen' => '1', 'horizontalSpace' => '10', 'verticalSpace' => '10', 'extension' => '' ]),
    'language' => 2,
];
$headers = [
    'Authorization: ' . $bearerToken
