...
# 2. Create Task
create_task_response = requests.get(CREATE_TASK_URL + "/img/csv?language=2", headers={"Authorization": bearer_token})
...
with open(pdf_path, "rb") as file:
    ...
    upload_payload = {
        "taskId": task_id,
        "parameter": '{  "isCsvMerge": 1 ,"isAllowOcr":1, "isOnlyAiTable":0 }',
        "language": "2"
    }
