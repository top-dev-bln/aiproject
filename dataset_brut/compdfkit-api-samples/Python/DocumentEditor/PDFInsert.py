...
# 2. Create Task
create_task_response = requests.get(CREATE_TASK_URL + "/pdf/insert?language=2", headers={"Authorization": bearer_token})
...
with open(pdf_path, "rb") as file:
    ...
    upload_payload = {
        "taskId": task_id,
        "parameter": '{"targetPage": "2","width": "500","height": "800", "number": "2"}',
        "language": "2"
    }
