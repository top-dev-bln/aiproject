...
# 2. Create Task
create_task_response = requests.get(CREATE_TASK_URL + "/pdf/html?language=2", headers={"Authorization": bearer_token})
...
with open(pdf_path, "rb") as file:
    ...
    upload_payload = {
        "taskId": task_id,
        "parameter": '{  "pageOptions": 1 ,  "isContainAnnot": 1 ,  "isContainImg": 1,"isAllowOcr":0,"isContainOcrBg":1,"isOnlyAiTable":0}',
        "language": "2"
    }
