...
# 2. Create Task
create_task_response = requests.get(CREATE_TASK_URL + "/pdf/pptx?language=2", headers={"Authorization": bearer_token})
...
with open(pdf_path, "rb") as file:
    ...
    upload_payload = {
        "taskId": task_id,
        "parameter": '{  "isContainAnnot": 1 ,  "isContainImg": 1,"isAllowOcr":0,"isContainOcrBg":0,"isOnlyAiTable":0}',
        "language": "2"
    }
