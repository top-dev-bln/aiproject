...
pdf_path = "input_files/html.html"
...
# 2. Create Task
create_task_response = requests.get(CREATE_TASK_URL + "/html/pdf?language=2", headers={"Authorization": bearer_token})
...
with open(pdf_path, "rb") as file:
    files = {
        'file': ('html.html', file, 'application/octet-stream'),
    }
    upload_payload = {
        "taskId": task_id,
        "language": "2"
