...
pdf_path = "input_files/word.docx"
...
# 2. Create Task
create_task_response = requests.get(CREATE_TASK_URL + "/docx/pdf?language=2", headers={"Authorization": bearer_token})
...
with open(pdf_path, "rb") as file:
    files = {
        'file': ('word.docx', file, 'application/octet-stream'),
    }
    upload_payload = {
        "taskId": task_id,
        "language": "2"
