...
# 2. Create Task
create_task_response = requests.get(CREATE_TASK_URL + "/pdf/addWatermark?language=2", headers={"Authorization": bearer_token})
...
with open(pdf_path, "rb") as file:
    ...
    upload_payload = {
        "taskId": task_id,
        "parameter": '{"type": "text","scale":"1","opacity":"0.5","rotation":"0.785","targetPages":"1","vertalign":"center","horizalign":"left","xoffset":"100","yoffset":"100","content":"test","textColor":"#59c5bb","front":"1","fullScreen":"1","horizontalSpace":"10","verticalSpace":"10","extension":""}',
        "language": "2"
    }
