...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      this.$session.get("/api/sys/logLogin/query", {
        params: queryParams
      }).then(res => {
...
<template>
  <div class="v-lu-content-container">
    ...
    >
      ...
      <el-table-column prop="deviceType" :label="$t('logLogin.deviceType')"/>
      <el-table-column prop="loginTypeDesc" :label="$t('common.type')"/>
