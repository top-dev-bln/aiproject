...
WARNING: 25-Nov-2025: Spring Boot 3.5.8 and Spring Boot 4.0.0 contain a regression which https://github.com/lbruun-net/Pre-Liquibase/issues/45[negatively affects]
Pre-Liquibase. You are advised to skip those releases, i.e. use v3.5.9+ / v4.0.1+ instead or 
stay on a previous version. Alternative strategies can be found https://github.com/lbruun-net/Pre-Liquibase/issues/45#issuecomment-3584363728[HERE].
...
- Java 17 or later
- Spring Boot 3.x or 4.x (for exact versions see <<Spring Boot compatibility>>)
...
----
(for the exact version to use see <<Spring Boot compatibility,Versions>>)
[start=2]
...
|JDK 17
|`main4`
|Current version for Spring Boot 4.x
...
|JDK 17
|`main3`
|Current version for Spring Boot 3.x
