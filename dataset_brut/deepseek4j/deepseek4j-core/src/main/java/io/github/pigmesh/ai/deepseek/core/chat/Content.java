...
public final class Content {
	...
	private boolean equalTo(Content another) {
		return Objects.equals(type, another.type) && Objects.equals(text, another.text)
				&& Objects.equals(imageUrl, another.imageUrl) && Objects.equals(inputAudio, another.inputAudio);
	}
	...
	public String toString() {
		return "Content{" + "type=" + type + ", text=" + text + ", imageUrl=" + imageUrl + ", inputAudio=" + inputAudio
				+ "}";
	}
