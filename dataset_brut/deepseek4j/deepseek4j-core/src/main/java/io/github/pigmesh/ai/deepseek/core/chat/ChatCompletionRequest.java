...
public class ChatCompletionRequest {
	...
	public String toString() {
		return "ChatCompletionRequest{" + "model=" + model + ", messages=" + messages + ", temperature=" + temperature
				+ ", topP=" + topP + ", n=" + n + ", stream=" + stream + ", streamOptions=" + streamOptions + ", stop="
				+ stop + ", maxTokens=" + maxTokens + ", maxCompletionTokens=" + maxCompletionTokens
	...
	public static final class Builder {
		...
		public Builder from(ChatCompletionRequest instance) {
			...
			includeReasoning(instance.includeReasoning);
			return this;
		}
